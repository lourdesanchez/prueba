...
void setup() {
  ...
  for(int i=0; i<cantImgCreditos; i++){
   imgCreditos[i] = loadImage(i+"0.jpg");
  }
  ...
  puntitoX=width/2;
  puntitoY=width/2;
  /*imagen0=loadImage("00.jpg");
  imagen1=loadImage("01.jpg");
  imagen2=loadImage("02.jpg");
  imagen3=loadImage("03.jpg");
  imagen4=loadImage("04.jpg");
  imagen5=loadImage("05.jpg");
  imagen6=loadImage("06.jpg");
  imagen7=loadImage("07.jpg");
  imagen8=loadImage("08.jpg");
  imagen9=loadImage("09.jpg");
  imagen10=loadImage("010.jpg");*/
